        ...
        <div class="row form-inline">
            <div class="col-6">
                ...
                <div class="form-group">
                    ...
                    <input classs="form-control" type="text" id="nombre" name="nombre" placeholder="Nombre Indicador" >
                </div>
            ...
            <div class="col-6">
                ...
                <div class="form-group">
                    ...
                    <input classs="form-control" type="text" id="categoria" name="categoria" placeholder="Categoria Indicador" >
                </div>

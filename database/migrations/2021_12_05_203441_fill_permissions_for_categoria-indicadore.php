...
class FillPermissionsForCategoriaIndicadore extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategoriaIndicadore constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categoria-indicadore',
            'admin.categoria-indicadore.index',
            'admin.categoria-indicadore.create',
            'admin.categoria-indicadore.show',
            'admin.categoria-indicadore.edit',
            'admin.categoria-indicadore.delete',
        ]);

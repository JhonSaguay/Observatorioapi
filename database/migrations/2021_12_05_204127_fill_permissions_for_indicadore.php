...
class FillPermissionsForIndicadore extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForIndicadore constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.indicadore',
            'admin.indicadore.index',
            'admin.indicadore.create',
            'admin.indicadore.show',
            'admin.indicadore.edit',
            'admin.indicadore.delete',
        ]);

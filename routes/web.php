...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(function () {
    ...
    Route::post('/admin/indicadores',                           'Admin\IndicadoresController@store')->name('indicadores.store');
    Route::get('/admin/indicadores/{indicadore}/edit',          'Admin\IndicadoresController@edit')->name('admin/indicadores/edit');
    Route::post('/admin/indicadores/bulk-destroy',              'Admin\IndicadoresController@bulkDestroy')->name('admin/indicadores/bulk-destroy');
    Route::post('/admin/indicadores/{indicadore}',              'Admin\IndicadoresController@update')->name('admin/indicadores/update');
    Route::delete('/admin/indicadores/{indicadore}',            'Admin\IndicadoresController@destroy')->name('admin/indicadores/destroy');
});

/* Auto-generated admin routes */
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(function () {
    Route::get('/admin/categoria-indicadores',                  'Admin\CategoriaIndicadoresController@index');
    Route::get('/admin/categoria-indicadores/create',           'Admin\CategoriaIndicadoresController@create');
    Route::post('/admin/categoria-indicadores',                 'Admin\CategoriaIndicadoresController@store')->name('categorias.store');;
    Route::get('/admin/categoria-indicadores/{categoriaIndicadore}/edit','Admin\CategoriaIndicadoresController@edit')->name('admin/categoria-indicadores/edit');
    Route::post('/admin/categoria-indicadores/bulk-destroy',    'Admin\CategoriaIndicadoresController@bulkDestroy')->name('admin/categoria-indicadores/bulk-destroy');
    Route::post('/admin/categoria-indicadores/{categoriaIndicadore}','Admin\CategoriaIndicadoresController@update')->name('admin/categoria-indicadores/update');
    Route::delete('/admin/categoria-indicadores/{categoriaIndicadore}','Admin\CategoriaIndicadoresController@destroy')->name('admin/categoria-indicadores/destroy');
    Route::get('/admin/categoria-indicadores/download/{categoria}', 'Admin\CategoriaIndicadoresController@download')->name('categoria.download');
});